---
title: 哪吒面板备份
cover: https://img-s-msn-com.akamaized.net/tenant/amp/entityid/AA1pya5z.img?w=640&h=908&m=6&x=220&y=51&s=126&d=126
swiper_index: 10
top_group_index: 10
background: '#fff'
date: 2024-08-28 09:37:26
updated:
tags:
categories:
keywords:
...
|  请输入 Oauth2 应用的 Client ID | github：创建的应用id  |
|  请输入 Oauth2 应用的 Client Secret |  github：创建的应用密码 |
