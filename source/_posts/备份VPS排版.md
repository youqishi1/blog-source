...
ruleset=🛑 广告拦截,https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/BanAD.lista
...
;自定义⬇️
ruleset=🎯 全球直连,https://raw.githubusercontent.com/youqishi1/ACL4SSR/refs/heads/main/Clash/zijian.list
...
;设置分组标志位
custom_proxy_group=🚀 节点选择`select`[]🇺🇲 美国节点`[]☑️ 手动切换`[]🇨🇦 加拿大`[]🇬🇧 英国节点`[]🇷🇺 俄罗斯节点`[]♻️ 自动选择`[]🇭🇰 香港节点`[]🇹🇼 台湾节点`[]🇸🇬 狮城节点`[]🇯🇵 日本节点`[]🇰🇷 韩国节点`[]📶 官方优选`[]DIRECT
custom_proxy_group=☑️ 手动切换`select`.*
custom_proxy_group=🇺🇲 美国节点`url-test`(美|波特兰|达拉斯|俄勒冈|凤凰城|费利蒙|硅谷|拉斯维加斯|洛杉矶|圣何塞|圣克拉拉|西雅图|芝加哥|US|United States|ATL|BUF|DFW|EWR|IAD|LAX|MCI|MIA|ORD|PHX|PDX|SEA|SJC)(?!.*(3X|3x|8X|8x|5x|5X|2x|2X)(?!.*0\.5x))`http://www.gstatic.com/generate_204`300,,150
custom_proxy_group=🇨🇦 加拿大`url-test`(CA|ca|加拿大)`http://www.gstatic.com/generate_204`300,,150
custom_proxy_group=🇬🇧 英国节点`url-test`(英|英国)`http://www.gstatic.com/generate_204`300,,150
custom_proxy_group=🇷🇺 俄罗斯节点`url-test`(🇷🇺|俄|俄罗斯|莫斯科)`http://www.gstatic.com/generate_204`300,,150
...
custom_proxy_group=🎥 奈飞视频`select`[]🚀 节点选择`[]♻️ 自动选择`[]🇸🇬 狮城节点`[]🇭🇰 香港节点`[]🇹🇼 台湾节点`[]🇯🇵 日本节点`[]🇺🇲 美国节点`[]🇰🇷 韩国节点`[]📶 官方优选`[]☑️ 手动切换`[]DIRECT`(NF|奈飞|解锁|Netflix|NETFLIX|Media|MITM)
custom_proxy_group=📺 巴哈姆特`select`[]🇹🇼 台湾节点`[]🚀 节点选择`[]☑️ 手动切换`[]DIRECT
custom_proxy_group=📺 哔哩哔哩`select`[]🎯 全球直连`[]🇹🇼 台湾节点`[]🇭🇰 香港节点
custom_proxy_group=🌍 国外媒体`select`[]🚀 节点选择`[]♻️ 自动选择`[]🇭🇰 香港节点`[]🇹🇼 台湾节点`[]🇸🇬 狮城节点`[]🇯🇵 日本节点`[]🇺🇲 美国节点`[]🇰🇷 韩国节点`[]📶 官方优选`[]☑️ 手动切换`[]DIRECT`(MITM)
...
custom_proxy_group=🇨🇦 加拿大`url-test`(CA|ca|加拿大|加)`http://www.gstatic.com/generate_204`300,,150
custom_proxy_group=🇬🇧 英国节点`url-test`(英|英国)`http://www.gstatic.com/generate_204`300,,150
custom_proxy_group=🇷🇺 俄罗斯节点`url-test`(🇷🇺|俄|俄罗斯|莫斯科)`http://www.gstatic.com/generate_204`300,,150
;设置分组标志位
